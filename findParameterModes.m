...
% This function takes a particle set and returns the mode of each
% parameter's marginal distribution (across the whole particle set).
% Additional optional inputs specify where to store the parameters present,
% and which parameters are "scale parameters" (which will be represented
% using their logarithm in the particle set).
%
% Usage:
%       param_modes = findParameterModes(particles, present_params, scale_params)
%
% INPUTS:
%
...
% OUTPUTS:
%
% param_modes - estimated modes of each parameter's marginal distribution
